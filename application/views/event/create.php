            ...
            <?=form_open('events/create')?>
              <div class="row">                
                  <div class="input-field col s10">
                    <input id="title" class="validate" type="text" name="title" autocomplete="off" value="<?php echo set_value('title'); ?>">
                    <label for="title">Title</label>                    
                  </div> 
                  <div class="input-field col s2">
                    <input id="date" class="datepicker" type="date" name="date" value="<?php echo set_value('date'); ?>">
                    <label for="date">Date</label>                    
                  </div>              
              </div><!--/.row-->
              <div class="row">
                <div class="col s12">
                  <textarea class="ckeditor" id="editor" name="description"><?php echo set_value('description'); ?></textarea>
                </div>
              </div>
              <div class="row">
