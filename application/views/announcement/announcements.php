                    ...
                    <div class="col s12">          
                      <ul id="projects-collection" class="collection">
                        <li class="collection-item avatar">
                          <i class="mdi-action-announcement circle amber"></i>
                          <span class="collection-header">Announcements</span>
                          <p>Alumni Announcements</p>                     
                        </li>
                        <?php if($results): ?>
                        <?php foreach ($results as $item): ?>                        
                          <li class="collection-item">
                            <div class="row">
                              <div class="col s8">
                                <p class="collections-title"><a href="<?=base_url('announcements/view/'.$item['id'])?>"><?=$item['title']?></a></p>
