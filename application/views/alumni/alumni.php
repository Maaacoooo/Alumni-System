                ...
                <div class="row margin-top-10">                                  
                  ...
                  foreach ($results as $item): ?>
                      ...
                      <a href="<?=base_url('users/edit/'.$item['id'])?>">
                        <?php                                                 
                          if($item['img'])    {
                            echo '<img src="'.base_url('uploads/'.$item['img']).'" alt="" class="circle">';
                          } else {
                      ...
                      <span class="title">
                        <a href="<?=base_url('profile/view/'.$item['id'])?>" class="strong"><?=$item['name']?> <?=$item['lastname']?></a> 
                        <?php if($item['course']):?>
                        ...
                        <?php endif; ?>
                        <small class="right italic"><?=$item['last_activity']?> <?=timespan(mysql_to_unix($item['last_activity_stamp']))?> ago</small>
