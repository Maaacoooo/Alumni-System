                    ...
                    <div class="row">
                          <?php echo form_open_multipart('alumni/create');?>
                           <div class="col s12 l6 m6"> 
                              ...
                              <div class="row">
                                <div class="col s12">
                                  <div class="card-panel light-green accent-4 white-text">
                                    <p>Disregarding the Username and Password field will Generate Default Data.</p>  
                                    <p><em>Username: <u> ID Number </u> <br/>Password: <u>1234</u></em></p>                                  
                                  </div>
                                </div>
                                <div class="input-field col s12">
                                  <input id="username" class="validate" type="text" name="username" autocomplete="off" value="<?php echo set_value('username'); ?>" minlength="3">
                           ...
                           <div class="col s12 l6 m6">
                              <div class="input-field col s12">
                                  <input id="id_num" class="validate" type="text" autocomplete="off" name="id_num" value="<?php echo set_value('id_num'); ?>" required>
                              ...
                              <div class="input-field col s12">
                                  <input id="middlename" class="validate" type="text" autocomplete="off" name="middlename" value="<?php echo set_value('middlename'); ?>" required>
                              ...
                              <div class="input-field col s12">
                                <select class="input-field" name="year" required>
                                  <option <?php if(!set_select('year')){echo 'selected';}?>>Choose Batch Year...</option>
                                    <?php foreach($years as $year): ?>
                                      <option value="<?=$year['id']?>" <?php echo set_select('year', $year['id']); ?>><?=$year['name']?></option>
                                    <?php endforeach;?>    
                                </select>
                              </div>
                              <div class="input-field col s12">
                                <select class="input-field" name="course" required>
                                  <option <?php if(!set_select('course')){echo 'selected';}?>>Choose Course...</option>
                                    <?php foreach($courses as $course): ?>
                                      <option value="<?=$course['id']?>" <?php echo set_select('course', $course['id']); ?>><?=$course['name']?> -- <?=$course['course_code']?></option>
                                    <?php endforeach;?> 
                                </select>
                              </div>  
                              <div class="input-field col s12">
                                  <input id="mobile" class="validate" type="number" autocomplete="off" name="mobile" value="<?php echo set_value('lastname'); ?>" required>
