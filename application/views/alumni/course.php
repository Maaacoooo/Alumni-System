        ...
        <div class="container">
          <div class="section">
                        ...
                        <?php if($results):?>
                          <?php foreach ($results as $item): ?>                        
                            <li class="collection-item">
                              <div class="row">
                                <div class="col s12">
                                  <p class="collections-title"><a href="<?=base_url('alumni/course/'.$item['id'])?>"><?=$item['name']?></a> <small class="italic"><?=$item['course_code']?></small></p>
                                  <p></p>
                                </div>                            
                              </div>
                            </li>                    
            ...
            <div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
              <a class="btn-floating btn-large red modal-trigger" href="#course_modal">
                <i class="large mdi-editor-mode-edit"></i>
              </a>
            </div>

            <?=$this->load->view('alumni/create_course_modal')?>
